...
// CommitSkill generates a SKILL.md for an opinionated git commit workflow.
type CommitSkill struct{}

func NewCommitSkill() *CommitSkill { return &CommitSkill{} }

func (c *CommitSkill) Name() string        { return "commit" }
func (c *CommitSkill) Description() string  { return "Atomic, semantic-boundary git commit workflow" }
func (c *CommitSkill) Source() schema.SkillSource {
	return schema.SkillSource{Path: ".claude/skills/commit/SKILL.md"}
}

func (c *CommitSkill) Content() string {
	return `# /commit — Atomic Commit Workflow
