...
- 3 built-in skills (commit, PR, review) plus 29 remote skills covering Pulumi IaC, Flux CD GitOps, Go, Python, TypeScript, Kubernetes, DevOps, SRE, AGENTS.md generation, and more
